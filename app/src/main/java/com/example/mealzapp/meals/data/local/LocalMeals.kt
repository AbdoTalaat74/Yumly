...
val mealsList = listOf(
    ...
    LocalMeal(
        ...
        strCategory = "Dessert",
        strInstructions = "Heat oven to 190C/170C fan/gas 5. Tip the flour and sugar into a large bowl. Add the butter, then rub into the flour using your fingertips to make a light breadcrumb texture...",
    ...
    LocalMeal(
        ...
        strMeal = "Apam balik",
        strCategory = "Dessert",
        strInstructions = "Mix milk, oil and egg together. Sift flour, baking powder and salt into the mixture...",
